...
class CANNet(nn.Module):
    def __init__(self, load_weights=False):
        ...
        # Using the first 13 layers of VGG-19
        self.frontend_feat = [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512]
        ...
        if not load_weights:
            mod = models.vgg19(pretrained=True)  # Load pre-trained VGG-19 model
            self._initialize_weights()

            # Copy weights from VGG-19 to the frontend
            fsd = collections.OrderedDict()
            for i, (key, _) in enumerate(self.frontend.state_dict().items()):
                fsd[key] = list(mod.state_dict().items())[i][1]
    ...
    def forward(self, x):
        ...
        # Fusion
        fi = (w1 * s1 + w2 * s2 + w3 * s3 + w6 * s6) / (w1 + w2 + w3 + w6 + 1e-12)
...
if __name__=="__main__":
    ...
    train_image_root = '/home/ipr_students/Tushaar/Context-Aware-Crowd-Counting/ShanghaiTech/part_A/train_data/images' #Train data images
    train_dmap_root = '/home/ipr_students/Tushaar/Context-Aware-Crowd-Counting/ShanghaiTech/part_A/train_data/ground_truth' #Train data ground truth
    test_image_root = '/home/ipr_students/Tushaar/Context-Aware-Crowd-Counting/ShanghaiTech/part_A/test_data/images' #Test data images
    test_dmap_root = '/home/ipr_students/Tushaar/Context-Aware-Crowd-Counting/ShanghaiTech/part_A/test_data/ground_truth' #Test data ground truth
    ...
    checkpoint_path = '/home/ipr_students/Tushaar/Context-Aware-Crowd-Counting/checkpoints1/epoch_66.pth'
    ...
    for epoch in range(epochs):
        ...
        torch.save(model.state_dict(), './checkpoints1/epoch_' + str(epoch) + ".pth")
